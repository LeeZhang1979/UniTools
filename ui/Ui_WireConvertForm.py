...
class Ui_WireConvertForm(object):
    def setupUi(self, WireConvertForm):
        ...
        WireConvertForm.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        ...
        self.label01 = QtWidgets.QLabel(parent=WireConvertForm)
        self.label01.setGeometry(QtCore.QRect(10, 10, 61, 20))
        self.label01.setObjectName("label01")
        self.lineEIFile = QtWidgets.QLineEdit(parent=WireConvertForm)
        ...
        self.btnStart = QtWidgets.QPushButton(parent=WireConvertForm)
        self.btnStart.setGeometry(QtCore.QRect(20, 130, 75, 20))
        self.btnStart.setObjectName("btnStart")
        self.btnCancel = QtWidgets.QPushButton(parent=WireConvertForm)
        self.btnCancel.setEnabled(False)
        self.btnCancel.setGeometry(QtCore.QRect(220, 130, 75, 20))
        self.btnCancel.setObjectName("btnCancel")
        self.btnIFile = QtWidgets.QToolButton(parent=WireConvertForm)
        self.btnIFile.setGeometry(QtCore.QRect(280, 10, 30, 20))
        self.btnIFile.setObjectName("btnIFile")
        self.spbStart = QtWidgets.QSpinBox(parent=WireConvertForm)
        self.spbStart.setGeometry(QtCore.QRect(120, 40, 51, 22))
        self.spbStart.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.spbStart.setMaximum(9999)
        self.spbStart.setProperty("value", 2)
        self.spbStart.setObjectName("spbStart")
        self.label02 = QtWidgets.QLabel(parent=WireConvertForm)
        self.label02.setGeometry(QtCore.QRect(60, 40, 61, 22))
        self.label02.setObjectName("label02")
        self.label03 = QtWidgets.QLabel(parent=WireConvertForm)
        self.label03.setGeometry(QtCore.QRect(170, 40, 91, 22))
        self.label03.setObjectName("label03")
        self.spbEnd = QtWidgets.QSpinBox(parent=WireConvertForm)
        self.spbEnd.setGeometry(QtCore.QRect(260, 40, 51, 22))
        self.spbEnd.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.spbEnd.setMinimum(0)
        self.spbEnd.setMaximum(9999)
        self.spbEnd.setProperty("value", 0)
        self.spbEnd.setObjectName("spbEnd")
        self.btnPause = QtWidgets.QPushButton(parent=WireConvertForm)
        self.btnPause.setEnabled(False)
        self.btnPause.setGeometry(QtCore.QRect(120, 130, 75, 20))
        self.btnPause.setObjectName("btnPause")
        self.label06 = QtWidgets.QLabel(parent=WireConvertForm)
        self.label06.setGeometry(QtCore.QRect(10, 70, 61, 20))
        self.label06.setObjectName("label06")
        self.lineEOFile = QtWidgets.QLineEdit(parent=WireConvertForm)
        ...
        self.btnOFile = QtWidgets.QToolButton(parent=WireConvertForm)
        self.btnOFile.setGeometry(QtCore.QRect(280, 70, 30, 20))
        self.btnOFile.setObjectName("btnOFile")
        self.cmbType = QtWidgets.QComboBox(parent=WireConvertForm)
        self.cmbType.setGeometry(QtCore.QRect(10, 40, 41, 22))
        self.cmbType.setObjectName("cmbType")
        self.cmbType.addItem("")
        self.cmbType.addItem("")
        self.progressBar = QtWidgets.QProgressBar(parent=WireConvertForm)
        self.progressBar.setGeometry(QtCore.QRect(80, 100, 231, 23))
        self.progressBar.setMaximum(0)
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.lblProgress = QtWidgets.QLabel(parent=WireConvertForm)
        self.lblProgress.setGeometry(QtCore.QRect(10, 100, 61, 20))
        ...
        self.lblProgress.setBuddy(self.lineEOFile)
    ...
    def retranslateUi(self, WireConvertForm):
        ...
        self.lblProgress.setText(_translate("WireConvertForm", "检查文件"))
